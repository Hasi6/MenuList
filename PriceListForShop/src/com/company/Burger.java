...
public class Burger {
    ...
    public double itemizedburger(){
        ...
        if(this.addition1Name != null){
            ...
            System.out.println("Added "+this.addition1Name+" for add extra "+this.addition1Price);
        }
        if(this.addition2Name != null){
            burgerPrice += this.addition2Price;
            System.out.println("Added "+this.addition2Name+" for add extra "+this.addition2Price);
        }
        if(this.addition3Name != null){
            burgerPrice += this.addition3Price;
            System.out.println("Added "+this.addition3Name+" for add extra "+this.addition3Price);
        }
        if(this.addition4Name != null){
            burgerPrice += this.addition4Price;
            System.out.println("Added "+this.addition4Name+" for adn extra "+this.addition4Price);
        }
        return burgerPrice;
    }
}
